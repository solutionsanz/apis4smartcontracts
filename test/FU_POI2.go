 ...
 * regarding copyright locationship.  The ASF licenses this file
...
func (s *SmartContract) initLedger(APIstub shim.ChaincodeStubInterface) sc.Response {
	pois := []POI{
		POI{PersonID: "4612", Person: "Ryan Klose", Action: "Established", Location: "Original"},
		POI{PersonID: "3071", Person: "Troy Wilson", Action: "Established", Location: "Original"},
		POI{PersonID: "4888", Person: "Christopher Lee", Action: "Established", Location: "Original"},
	}
...
func (s *SmartContract) createPOI(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {
	...
	var poi = POI{PersonID: args[1], Person: args[2], Action: args[3], Location: args[4]}
